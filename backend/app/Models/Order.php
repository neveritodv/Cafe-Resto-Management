...
class Order extends Model {
    ...
    public function getStatusColorAttribute() { return match($this->status) { 'pending'=>'yellow','preparing'=>'blue','ready'=>'green','served'=>'indigo','paid'=>'emerald','cancelled'=>'red', default=>'gray' }; }
    public function getStatusLabelAttribute() { return match($this->status) { 'pending'=>'En attente','preparing'=>'En pr?paration','ready'=>'Pr?t','served'=>'Servi','paid'=>'Pay?','cancelled'=>'Annul?', default=>$this->status }; }
}
